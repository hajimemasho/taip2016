...
public class Paillier {
	...
	public void KeyGeneration(int bitLengthVal, int certainty) {
		 ...
		 */
		p = new BigInteger(bitLength / 2, certainty, new Random());//new BigInteger("7");
		q = new BigInteger(bitLength / 2, certainty, new Random());//new BigInteger("11");

		n = p.multiply(q);
		nsquare = n.multiply(n);

		g = new BigInteger("5652");//new BigInteger("2");
		lambda = p
